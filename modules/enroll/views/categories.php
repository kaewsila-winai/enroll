<?php
/**
 * @filesource modules/enroll/views/categories.php
 *
...
class View extends \Gcms\View
{
    ...
    public function render($index)
    {
        ...
        $form = Html::create('form', array(
            ...
            'class' => 'setup_frm',
            'autocomplete' => 'off',
            'action' => 'index.php/enroll/model/categories/submit',
        ...
        $table = new DataTable(array(
            /* ข้อมูลใส่ลงในตาราง */
            'datas' => \Enroll\Categories\Model::toDataTable($index->type),
