<?php
/**
 * @filesource modules/enroll/controllers/categories.php
 *
...
class Controller extends \Gcms\Controller
{
    ...
    public function render(Request $request)
    {
        $index = (object) array(
            ...
            'categories' => Language::get('ENROLL_TYPIES'),
        );
        ...
        if (Login::checkPermission(Login::isMember(), 'can_manage_enroll')) {
            ...
            // แสดงฟอร์ม
            $section->appendChild(createClass('Enroll\Categories\View')->render($index));
            // คืนค่า HTML
