...
function initProvince(prefix) {
  ...
  initAutoComplete(
    prefix + "district",
    WEB_URL + "index.php/index/model/autocomplete/district",
  ...
  initAutoComplete(
    prefix + "amphur",
    WEB_URL + "index.php/index/model/autocomplete/amphur",
    "district,amphur,province",
    "location",
    o
  );
  initAutoComplete(
    prefix + "province",
    WEB_URL + "index.php/index/model/autocomplete/province",
    "district,amphur,province",
    "location",
    o
  );
